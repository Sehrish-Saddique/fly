  ...
  return (
    <div className='info section'>
      ...
      <div className="titleDiv flex">
        <h2 data-aos='fade-right' data-aos-duration='2300'>Travel to make memories all round the world</h2>
        <button className='btn ' data-aos='fade-left' data-aos-duration='2300'>View All</button>
      </div>
